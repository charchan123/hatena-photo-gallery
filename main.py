...
(function () {
  ...
  crumb.style.fontSize = "13px";
  crumb.style.margin = "8px 0 16px";
  crumb.style.color = "#666";

  crumb.innerHTML = `
    <a href="index.html" style="color:#555; text-decoration:none;">
      トップ
    </a>
    <span style="margin:0 4px;">›</span>
    <a href="${kana}.html" style="color:#555; text-decoration:none;">
      ${kana}
    </a>
    <span style="margin:0 4px;">›</span>
...
(function () {
  ...
  crumb.innerHTML = `
    <a href="index.html" style="color:#555;">トップ</a>
    <span> › </span>
    <span style="color:#999;">${kana}</span>
  `;
...
(function () {
  ...
  if (from === "aiuo" && kana) {
    middle = `<a href="${kana}.html">五十音 › ${kana}</a>`;
  } else if (from === "index") {
    middle = `<a href="index.html">全キノコ検索</a>`;
  } else if (from === "recommend") {
    middle = `<a href="index.html#recommend">おすすめキノコ</a>`;
  } else {
    return; // 直アクセスは出さない（うるさくしない）
  }
